...
- 3000 press responses (IDs 1–3000, stable — do not renumber), 7 escalation acts with rare early "leaks" woven throughout. The third thousand adds awards shows, heists, robots, dinosaurs, musicals, dating apps, academia, economics, camping, cruises, and a campaign-to-coronation arc ending at THREE THOUSAND.
- 25 achievements, escalation director (supervisor saga, expunged clicks, flips, shakes, spins, flashes, warps, hides, morphs, rainbow, jitter, quakes, footer log). The button goes feral after 200, hatches at 1000, and governs from 2800. Mercy rule: tiny buttons never dodge.
...
Messages live in the `MESSAGES` block in `index.html`. Append `{id:3001, act:N, rare:0|1, text:"..."}` — engine, shuffle-bag, and achievements need no code changes.
